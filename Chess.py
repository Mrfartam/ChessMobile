...
def check(game):
    ...
    if game.status_game == 1:
        ...
        for figure in game.white_stuff[:len(game.white_stuff)-1]:
        ...
        for figure in game.black_stuff[:len(game.black_stuff)-1]:
            if figure.gettype == "Pown" and game.simulation == 0:
                if figure.virginity != 3:
                    figure.virginity -= 1
            game.status_check -= 1
...
class Pawn(Figure):
    ...
    def interactive(self, new_position, last_position, game, figure_im = ""):
